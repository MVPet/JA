	...
	, mStatisticsNumFrames(0)
{
	...
	mTextures.load(Textures::TitleScreen, "Assets/Menus/TitleScreen.png");

	mStatisticText.setFont(mFonts.get(Fonts::Main));
	mStatisticText.setPosition(5.f, 5.f);
	mStatisticText.setCharacterSize(10u);
...
void Application::updateStatistics(sf::Time dt)
{
	...
	{
		mStatisticText.setString("FPS: " + toString(mStatisticsNumFrames));
